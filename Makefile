...
CFLAGS = -Iinclude -std=gnu99 -fno-builtin-putchar -nostartfiles	\
 -nodefaultlibs -nostdinc -Wall -Wextra -fno-stack-protector		\
 -ffreestanding -march=armv5t -mfloat-abi=hard -mfpu=fpa			\
 -include stddef.h
